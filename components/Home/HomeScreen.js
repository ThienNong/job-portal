...
export default class HomeScreen extends Component {
  ...
  getNewJob() {
    ...
    fetch('https://chovieclam.net/api/getNewJobs.php')
      .then((response) => response.json())
      .then((responseJson) => {
        if (this._isMounted) {
          this.setState({
  ...
  componentDidMount() {
    ...
    getToken()
      ...
      .then((res) => {
        ...
        if (global.reloadSavedJob) global.reloadSavedJob();
        if (global.reloadUserMenu) global.reloadUserMenu();
      })
      .catch((err) => {
        console.log(err);
      });
            ...
            <View style={style.container}>
              <View style={style.search}>
                ...
                <TouchableOpacity
                  ...
                  <Text style={style.buttonText}>Tìm kiếm công việc</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    if (global.user == null) {
                      Alert.alert("", "Bạn chưa đăng nhập. Vui lòng đăng nhập để sử dụng tính năng này!");
                    }
                    else {
                  ...
                  <Text style={style.buttonText}>Giao diện nhà tuyển dụng</Text>
                </TouchableOpacity>
              </View>
